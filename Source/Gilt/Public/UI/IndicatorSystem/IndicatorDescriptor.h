 ...
 */
UCLASS()
class GILT_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UGiltIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UGiltIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UGiltIndicatorManagerComponent> ManagerPtr;
