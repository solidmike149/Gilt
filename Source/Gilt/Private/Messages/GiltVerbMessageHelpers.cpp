...
#include "Messages/GiltVerbMessageHelpers.h"
...
FString FGiltVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FGiltVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UGiltVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UGiltVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UGiltVerbMessageHelpers::VerbMessageToCueParameters(const FGiltVerbMessage& Message)
{
...
FGiltVerbMessage UGiltVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FGiltVerbMessage Result;
