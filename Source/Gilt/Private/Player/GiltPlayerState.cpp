...
const FName AGiltPlayerState::NAME_GiltAbilityReady("GiltAbilitiesReady");
...
AGiltPlayerState::AGiltPlayerState(const FObjectInitializer& ObjectInitializer)
{
	...
	CreateDefaultSubobject<UGiltBasicSet>("HealthSet");
}
...
void AGiltPlayerState::SetPawnData(const UGiltPawnData* InPawnData)
{
	...
	UGameFrameworkComponentManager::SendGameFrameworkComponentExtensionEvent(this, NAME_GiltAbilityReady);
}
